...
class ApprecieManager extends ModelManager{
    ...
    public function getNbParticipants(){
        $sql = 'Select Count(distinct(idAdministré)) FROM apprécie';
    ...
    public function getNbAliments(){
        $sql ="Select Count(distinct(alim_code)) FROM apprécie";
    ...
    public function getTop10Aliments(){
        ...
        FROM apprécie GROUP BY id_aliment ORDER BY nb_choix  DESC LIMIT 10";
